...
public class documentDController implements Initializable {
    ...
    public void generateReport() {
        try{
            ...
            try{
                File reporte = new File("src"+File.separator+"Reportes"+ File.separator+"Reporte D - "+calendar.get(Calendar.YEAR)+"-"+calendar.get(Calendar.MONTH)+"-"+calendar.get(Calendar.DAY_OF_MONTH)+"-"+calendar.get(Calendar.HOUR_OF_DAY)+".txt"); //00054123 Generando el archivo de texto donde está el reporte con formato ReporteB - fecha y hora
